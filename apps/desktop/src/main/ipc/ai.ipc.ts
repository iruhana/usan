...
function getLocalModeReply(locale: Locale, userMessage: string): string {
  ...
  if (locale === 'en') {
    return [
      'You are currently using Usan basic mode because no AI model is connected.',
      '',
      ...
      '',
      'If you connect an optional OpenRouter API key or local AI runtime in Settings, advanced AI reasoning will be enabled.',
  ...
  if (locale === 'ja') {
    return [
      ...
      '- \u300c\u4eca\u65e5\u306e\u5929\u6c17\u3092\u691c\u7d22\u3057\u3066\u300d',
      '',
      '\u8a2d\u5b9a\u304b\u3089 OpenRouter API \u30ad\u30fc\u307e\u305f\u306f\u30ed\u30fc\u30ab\u30eb AI \u30e9\u30f3\u30bf\u30a4\u30e0\u3092\u63a5\u7d9a\u3059\u308b\u3068\u3001\u9ad8\u5ea6\u306a AI \u6a5f\u80fd\u304c\u6709\u52b9\u306b\u306a\u308a\u307e\u3059\u3002',
      quoted ? `\u3054\u8cea\u554f: \u300c${quoted}\u300d` : '',
  ...
  return [
    '\uc9c0\uae08\uc740 AI \ubaa8\ub378\uc774 \uc5f0\uacb0\ub418\uc9c0 \uc54a\uc740 \uae30\ubcf8 \ubaa8\ub4dc \uc0c1\ud0dc\uc785\ub2c8\ub2e4.',
    '',
    ...
    '- "\uc624\ub298 \ub0a0\uc528 \uac80\uc0c9\ud574\uc918"',
    '',
    '\uc124\uc815\uc5d0\uc11c \uc120\ud0dd\uc801\uc73c\ub85c OpenRouter API \ud0a4 \ub610\ub294 \ub85c\uceec AI \ub7f0\ud0c0\uc784\uc744 \uc5f0\uacb0\ud558\uba74 \uace0\uae09 AI \uae30\ub2a5\uc774 \ud65c\uc131\ud654\ub429\ub2c8\ub2e4.',
    quoted ? `\uc694\uccad \ub0b4\uc6a9: "${quoted}"` : '',
