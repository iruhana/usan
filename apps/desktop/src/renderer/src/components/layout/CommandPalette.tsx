...
export default function CommandPalette({ open, onOpenChange, onNavigate }: CommandPaletteProps) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[20vh]">
      ...
      {/* Command dialog */}
      <div className="relative w-full max-w-lg bg-[var(--color-bg-card)] rounded-2xl shadow-2xl overflow-hidden">
          ...
          <Command.List className="max-h-80 overflow-auto p-2">
            ...
            <Command.Group heading={t('command.actions')} className="px-2 py-1">
              <Command.Item
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer hover:bg-[var(--color-primary-light)] transition-colors"
                style={{ minHeight: 'var(--min-target)' }}
              >
                <Monitor size={20} className="text-[var(--color-primary)]" />
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('command.screenAnalyze')}</span>
              </Command.Item>
              <Command.Item
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('command.findFile')}</span>
              </Command.Item>
              <Command.Item
                onSelect={() => { onNavigate('home'); onOpenChange(false) }}
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer hover:bg-[var(--color-primary-light)] transition-colors"
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('command.search')}</span>
              </Command.Item>
            </Command.Group>
            ...
            <Command.Group heading={t('nav.tools')} className="px-2 py-1">
              ...
              >
                <Monitor size={20} className="text-[var(--color-primary)]" />
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('tools.screenCapture')}</span>
              </Command.Item>
              <Command.Item
                onSelect={() => { onNavigate('tools'); onOpenChange(false) }}
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer hover:bg-[var(--color-primary-light)] transition-colors"
              ...
              >
                <Globe size={20} className="text-[var(--color-primary)]" />
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('tools.webSearch')}</span>
              </Command.Item>
              <Command.Item
                onSelect={() => { onNavigate('tools'); onOpenChange(false) }}
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer hover:bg-[var(--color-primary-light)] transition-colors"
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('tools.tts')}</span>
              </Command.Item>
              <Command.Item
                onSelect={() => { onNavigate('tools'); onOpenChange(false) }}
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer hover:bg-[var(--color-primary-light)] transition-colors"
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('tools.reminder')}</span>
              </Command.Item>
            </Command.Group>
            ...
            <Command.Group heading={t('command.navigate')} className="px-2 py-1">
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('nav.home')}</span>
              </Command.Item>
              <Command.Item
                onSelect={() => { onNavigate('tools'); onOpenChange(false) }}
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer hover:bg-[var(--color-primary-light)] transition-colors"
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('nav.tools')}</span>
              </Command.Item>
              <Command.Item
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('nav.notes')}</span>
              </Command.Item>
              <Command.Item
                onSelect={() => { onNavigate('files'); onOpenChange(false) }}
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer hover:bg-[var(--color-primary-light)] transition-colors"
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('nav.files')}</span>
              </Command.Item>
              <Command.Item
              ...
              >
                ...
                <span style={{ fontSize: 'var(--font-size-sm)' }}>{t('nav.settings')}</span>
              </Command.Item>
            </Command.Group>
          </Command.List>
        </Command>
