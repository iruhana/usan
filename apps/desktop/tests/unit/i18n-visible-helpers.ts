...
export const VISIBLE_UI_FILES = [
  ...
  'src/renderer/src/pages/AccountPage.tsx',
  ...
  'src/renderer/src/pages/WorkflowsPage.tsx',
  'src/renderer/src/components/workflow/WorkflowBuilder.tsx',
  'src/renderer/src/components/workflow/WorkflowRunLog.tsx',
] as const

export const SUPPORT_PANEL_FILES = [
  'src/renderer/src/components/email/EmailInbox.tsx',
  'src/renderer/src/components/email/EmailCompose.tsx',
  'src/renderer/src/components/calendar/CalendarView.tsx',
  'src/renderer/src/components/file-org/DuplicateList.tsx',
  'src/renderer/src/components/file-org/OrganizationPreview.tsx',
  'src/renderer/src/components/mcp/McpServerList.tsx',
  'src/renderer/src/components/mcp/McpToolPanel.tsx',
  'src/renderer/src/components/macro/MacroPanel.tsx',
  'src/renderer/src/components/monitors/MonitorSelector.tsx',
  'src/renderer/src/components/vision/VisionPanel.tsx',
  'src/renderer/src/components/image/ImageEditor.tsx',
  'src/renderer/src/components/orchestration/AppLauncherHelper.tsx',
  'src/renderer/src/components/layout/CommandPalette.tsx',
  'src/renderer/src/components/clipboard/ClipboardHistory.tsx',
  'src/renderer/src/components/hotkeys/HotkeySettings.tsx',
  'src/renderer/src/components/hotkeys/HotkeyRecorder.tsx',
